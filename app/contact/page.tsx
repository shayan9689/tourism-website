      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-soft p-8 border border-gray-100 sticky top-24">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-600 ml-13">shayanumair.dev@gmail.com</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 ml-13">+923107679332</p>
                </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-soft p-8 border border-gray-100">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white px-6 py-4 rounded-xl font-semibold transition-all duration-200 shadow-md hover:shadow-lg"
                >
                  Send Message
                </button>
              </form>
