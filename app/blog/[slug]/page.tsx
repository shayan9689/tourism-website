    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="relative h-[400px] md:h-[500px] overflow-hidden bg-gradient-to-br from-blue-700 via-blue-800 to-cyan-900 dark:from-blue-900 dark:via-blue-950 dark:to-black">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
          <div className="mb-4">
            <span className="bg-blue-600 dark:bg-blue-500 text-white px-4 py-2 rounded-full text-sm font-semibold">
              {post.category}
            </span>
          </div>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
          <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-50 mb-4">Tags</h3>
          <div className="flex flex-wrap gap-2">
            {post.tags.map((tag, index) => (
              <span
                key={index}
                className="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-full text-sm"
              >
                {tag}
              </span>
            ))}
